    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>This is a placeholder page for MEDICINE HISTORY. Here you would typically see relevant data fetched from the backend API.</Text>
        </View>
