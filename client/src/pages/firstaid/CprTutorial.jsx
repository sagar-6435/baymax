...
const cprIllustration = require('../../../assets/firstaid/cpr.jpg');
...
const CprTutorial = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <AppHeader showBack={true} onBack={() => navigation.goBack()} title="CPR Guide" />
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.illustrationWrapper}>
          <Image source={cprIllustration} style={styles.illustrationImage} resizeMode="contain" />
        </View>
