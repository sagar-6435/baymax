...
const EditMedicineReminder = ({ navigation, route }) => {
  const reminder = route.params?.reminder || { name: 'Paracetamol', dosage: '1 pill' };
  const [medName, setMedName] = useState(reminder.name);
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.timeGrid}>
          <TouchableOpacity style={[styles.timeSelect, { backgroundColor: colors.primary }]}>
            <Text style={[styles.timeSelectText, { color: colors.white }]}>08:00 AM</Text>
          </TouchableOpacity>
...
export default EditMedicineReminder;
