...
const EXCLUDED_FILES = [
  ...
  'FirstAidHome.jsx',
  'SplashScreen.jsx',
  'WelcomeOnboardingScreen1.jsx',
  'WelcomeOnboardingScreen2.jsx',
  'WelcomeOnboardingScreen3.jsx',
  'PermissionsIntroductionScreen.jsx',
  'CameraPermission.jsx',
  'MicrophonePermission.jsx',
  'SensorPermission.jsx',
  'BluetoothDevicePermission.jsx'
];

function getTemplate(componentName) {
  let headerTitle = componentName.replace(/([A-Z])/g, ' $1').trim().toUpperCase();
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>This is a placeholder page for ${headerTitle}. Here you would typically see relevant data fetched from the backend API.</Text>
        </View>
  ...
  for (const file of files) {
    ...
    if (stat.isDirectory()) {
      ...
      if (!EXCLUDED_FILES.includes(file)) {
        ...
        const newContent = getTemplate(componentName);
